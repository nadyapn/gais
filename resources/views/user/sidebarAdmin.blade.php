				...
				<div class="menu-list">
					<ul id="menu-content" class="menu-content collapse out">
						<li class="active">
						  ...
						  <img style="margin-left:10px;margin-right:5px"src="img/dashboard-white.png"> Dashboard <b> Admin </b>
						  </a>
						</li>

						<li  data-toggle="collapse" data-target="#Employee-Self-Service" class="collapsed">
						  <a href="#"><img style="margin-left:10px;margin-right:5px"src="img/sheet.png"> View My Log <span class="arrow"></span></a>
						</li>
						...
						<li data-toggle="collapse" data-target="#service" class="collapsed">
						  <a href="#"><img style="margin-left:10px;margin-right:5px"src="img/calendar-white.png"> Shared Facilities <b>Special Menu</b></a>
						</li> 
					</ul>
			 </div>
		</div>    
